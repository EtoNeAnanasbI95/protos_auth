...
func (c *authClient) Validate(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuthServer) Validate(context.Context, *TokenRequest) (*emptypb.Empty, error) {
